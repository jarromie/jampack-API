...
public class BankItemWidget implements Widget {
    ...
    public String[] getActions() {
        ...
        //0
        switch (InteractionApiPlugin.getClient().getVarbitValue(6590)) {
            case 0:
            ...
            case 2:
                ...
                break;
            case 3:
                actions[0] = "Withdraw-" + InteractionApiPlugin.getClient().getVarbitValue(3960);
                break;
            case 4:
        ...
        //1
        if (InteractionApiPlugin.getClient().getVarbitValue(6590) != 0) {
        ...
        //4
        if (InteractionApiPlugin.getClient().getVarbitValue(3960) > 0) {
            actions[4] = "Withdraw-" + InteractionApiPlugin.getClient().getVarbitValue(3960);
        }
        ...
        //8
        if (InteractionApiPlugin.getClient().getVarbitValue(3755) == 0) {
